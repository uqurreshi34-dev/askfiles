...
function getBackgroundSet(dark: boolean, palette: string) {
  const sets: Record<string, { background: string; surface: string; surfaceAlt: string; card: string; border: string; divider: string }> = {
    ...
    sage: { background: '#F0F4EC', surface: '#E4EBDC', surfaceAlt: '#F7FAF3', card: '#ffffff', border: '#DCE5D2', divider: '#D6E0CA' },
    blush: { background: '#FAF0EE', surface: '#F3E2DE', surfaceAlt: '#FDF6F5', card: '#ffffff', border: '#F0DDD9', divider: '#EBD3CD' },
    sky: { background: '#EDF3F8', surface: '#DEE9F2', surfaceAlt: '#F5F9FC', card: '#ffffff', border: '#D6E4EF', divider: '#CCDCEA' },
    sand: { background: '#F7F2E9', surface: '#EFE6D4', surfaceAlt: '#FBF7EF', card: '#ffffff', border: '#EBE0CB', divider: '#E4D6BC' },
