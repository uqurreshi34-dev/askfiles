...
const styles = StyleSheet.create({
  ...
  safeArea: { flex: 1 },
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 0.5, borderBottomColor: '#333' },
  iconBtn: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center' },
  fileName: { flex: 1, fontSize: 14, fontWeight: '500', color: '#fff', marginHorizontal: 8 },
  imageWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 16 },
  image: { width, height: height * 0.72 },
  footer: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 0.5, borderTopColor: '#333', gap: 12 },
  footerName: { flex: 1, fontSize: 13, color: '#888780' },
  shareButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#185FA5', paddingHorizontal: 20, paddingVertical: 8, borderRadius: 8 },
  shareButtonText: { fontSize: 13, fontWeight: '500', color: '#fff' },
});
