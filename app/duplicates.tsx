...
const styles = StyleSheet.create({
  ...
  summaryCard: { borderRadius: 16, padding: 16, marginBottom: 16, flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 8 },
  summaryRow: { alignItems: 'center', flex: 1 },
  summaryCount: { fontSize: 24, fontWeight: '700', letterSpacing: -0.5 },
